                ...
                <div className="about-content">
                    <section className="about-section">
                        ...
                        <p className="about-paragraph">
                            We at Prime-Fit, have taken a vow to make our #PRIMEFITArmy healthy and happy. We have been winning the battle for the last 10 years when we started our journey. Today our family comprises thousands of members and we are growing every day.
                        </p>
                        <p className="about-paragraph">
