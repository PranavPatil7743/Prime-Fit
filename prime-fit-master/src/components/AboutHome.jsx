    ...
    return (
        <section className="about-home">
            ...
            <p className="about-home__block">
                <span className="lead">We</span>, at Prime-Fit are <strong>the most effective lifestyle studio</strong> in the country.We, at Prime-Fit, believe in living healthy and happy. Our focus is to help you guide you to a better life style. We focus on nutrition, cross-fit exercise, endurance training, increasing positivity in life and much more.  Our trainers are there to help you whenever you need. They will guide you, mentor you, motivate you and help you become the best YOU. 
            </p>
            <h1 className="about-home__heading about-home__heading--sub">
                Our Goal
            </h1>
            <p className="about-home__block">
                 We, at Prime-Fit, promise you to help you become healthy, fit, energetic, mentally healthy and calm. We strive to keep you fit & healthy through a range of holistic offerings that include fitness and yoga, healthy meals, mental wellbeing and primary care. Now anyone can now stay healthy from the safety of their homes with just a single app that helps you to <strong>#BeBetterEveryDay</strong>
